...
import { GetDateModel, dateModel } from './../../../models/campaigndate.model';
...
@Component({
  ...
  providers: [DatePipe, AppointmentHistoryService, SlotConfigurationService]
})
...
datemodel: dateModel;
  ...
  appointmenthistoryModel: AppointmentHistoryModel;
...
todate: INgxMyDpOptions = {
  ...
  constructor(public datepipe: DatePipe,
    ...
    , vcr: ViewContainerRef, private _appointmenthistoryService: AppointmentHistoryService) {
    this.enterdatests1 = false;
    this.appointmenthistoryModel = new AppointmentHistoryModel;
...
//    console.log('dddddddddd' + this.selectedDate1);
 ...
 //  console.log(this.datefilter);
   ...
   if (this.datefilter.FromDate !== '' && this.datefilter.ToDate !== '') {
        return this._appointmenthistoryService.ApptHistoryPost(this.datefilter).subscribe(
            res => {
...
PostAppthistorydata() {
    if (this.ApptHistoryForm.dirty && this.ApptHistoryForm.valid )  {
       // alert(JSON.stringify(this.model));
        this._appointmenthistoryService.ApptHistoryPost(this.appointmenthistoryModel).subscribe(
            res => {
